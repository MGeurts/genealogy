...
return [
    ...
    'people_search_help_1'      => 'O sistema pesquisará nomes nos campos <b class="text-emerald-600">sobrenome</b>, <b class="text-emerald-600">nome</b>, <b class="text-emerald-600">nome de nascimento</b> e <b class="text-emerald-600">apelido</b>.',
    'people_search_help_2'      => 'Como pesquisar :',
    'people_search_help_2a'     => 'Digite qualquer parte de um nome para encontrar correspondências <span class="italic">(ex.: "Kennedy")</span>',
    'people_search_help_2b'     => 'Pesquise várias palavras para reduzir os resultados <span class="italic">(ex.: "John Kennedy")</span>',
    'people_search_help_2c'     => 'A ordem das palavras não importa <span class="italic">("Kennedy John" = "John Kennedy")</span>',
    'people_search_help_2d'     => 'Use aspas para nomes com espaços <span class="italic">(ex.: "John Fitzgerald Jr.")</span>',
    'people_search_help_2e'     => 'Comece com <b class="text-emerald-600">%</b> para uma pesquisa por substring <span class="italic">(ex.: "%Jr.")</span>',
    'people_search_help_3'      => 'Nota : <b class="text-emerald-600">Pesquisas curtas (1–2 caracteres) ou wildcard (%) podem demorar mais em grandes árvores genealógicas</b>.',
    ...
    'check_breach'         => 'Verifique se o seu endereço de e-mail está em uma violação de dados',
];
