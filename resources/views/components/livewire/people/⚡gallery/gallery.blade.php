        ...
        <div class="flex items-center justify-center mb-2 print:hidden">
            ...
            @if (count($images) <= 7)
                @foreach (range(0, count($images) - 1) as $i)
                    @if ($i === $selected)
                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-500 border border-gray-300 cursor-default select-none bg-yellow-500 dark:bg-yellow-200">
                            {{ $i + 1 }}
                        </span>
                    @else
            ...
            @else
                ...
                @if ($selected >= 3)
                    <span aria-disabled="true" class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium leading-5 text-gray-700 bg-white border border-gray-300 cursor-default select-none">
                        ...
                    </span>
                @endif
