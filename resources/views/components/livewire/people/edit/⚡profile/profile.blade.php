    ...
    <div class="md:w-3xl flex flex-col rounded-sm bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 text-neutral-800 dark:text-neutral-50">
        ...
        <div class="p-4 bg-neutral-200">
            ...
            <div class="grid grid-cols-6 gap-5">
                ...
                {{-- dob --}}
                <div class="col-span-6 md:col-span-3">
                    <x-ts-date wire:model="dob" id="dob" name="dob" label="{{ __('person.dob') }} :" format="YYYY-MM-DD" :max-date="now()" placeholder="{{ __('app.select') }} ..." />
                </div>
                ...
                {{-- summary --}}
                <div class="col-span-6">
                    <x-ts-textarea wire:model="summary" id="summary" label="{{ __('person.summary') }} :" autocomplete="summary" maxlength="65535" count />
                </div>
            </div>
        </div>
