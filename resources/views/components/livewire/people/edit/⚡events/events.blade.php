<div>
    ...
    <x-ts-modal wire="showModal" size="2xl">
        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <!-- Event Type -->
            <div>
                <x-ts-select.styled wire:model="type" id="type" label="{{ __('personevents.event') }} :" :options="$this->eventTypes()" select="label:name|value:id"
                    placeholder="{{ __('app.select') }} ..." required />
            </div>
