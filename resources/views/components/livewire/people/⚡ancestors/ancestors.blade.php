<div>
    ...
    <div class="md:min-w-max md:max-w-sm">
        <div class="overflow-x-auto">
            <div>
                <div
                    class="min-w-xs print:break-before-page flex flex-col rounded-sm bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 text-neutral-800 dark:text-neutral-50">
                        ...
                        <div class="flex flex-wrap items-start justify-center gap-2">
                            ...
                            <div class="flex-1 grow max-w-full min-w-max text-end">
                                @if (count($ancestors) > 1)
                                    <x-ts-badge color="emerald" sm class="me-2" text="{{ $this->displayedAncestorsCount - 1 }} / {{ count($ancestors) - 1 }}" />
                                @endif
