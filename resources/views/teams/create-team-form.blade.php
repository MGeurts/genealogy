<x-form-section submit="createTeam">
    <x-slot name="title">
        <div class="dark:text-gray-400">{{ __('team.team_details') }}</div>
    </x-slot>

    <x-slot name="description">
        <div class="dark:text-gray-100">{{ __('team.team_create_new') }}</div>
    </x-slot>
    ...
    <x-slot name="actions">
        <x-ts-button type="submit" color="primary"> {{ __('team.create') }} </x-ts-button>
    </x-slot>
</x-form-section>
