    ...
    <div class="md:w-192 flex flex-col rounded bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 text-neutral-800 dark:text-neutral-50"">
        ...
        <div class="p-4 bg-neutral-200">
            <div class="grid grid-cols-6 gap-5">
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    <x-input-error for="profileForm.nickname" class="mt-1" />
                </div>
                    ...
                    <div class="flex">
                        <div class="mt-3 mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                            <input
                                ...
                                type="radio" name="sex" id="sexM" value="m" wire:model="profileForm.sex" />
                        ...
                        <div class="mt-3 mb-[0.125rem] mr-4 inline-block min-h-[1.5rem] pl-[1.5rem]">
                            <input
                                class="relative float-left -ml-[1.5rem] mr-1 mt-0.5 h-5 w-5 appearance-none rounded-full border-2 border-solid border-neutral-300 before:pointer-events-none before:absolute before:h-4 before:w-4 before:scale-0 before:rounded-full before:bg-transparent before:opacity-0 before:shadow-[0px_0px_0px_13px_transparent] before:content-[''] after:absolute after:z-[1] after:block after:h-4 after:w-4 after:rounded-full after:content-[''] checked:border-primary checked:before:opacity-[0.16] checked:after:absolute checked:after:left-1/2 checked:after:top-1/2 checked:after:h-[0.625rem] checked:after:w-[0.625rem] checked:after:rounded-full checked:after:border-primary checked:after:bg-primary checked:after:content-[''] checked:after:[transform:translate(-50%,-50%)] hover:cursor-pointer hover:before:opacity-[0.04] hover:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:shadow-none focus:outline-none focus:ring-0 focus:before:scale-100 focus:before:opacity-[0.12] focus:before:shadow-[0px_0px_0px_13px_rgba(0,0,0,0.6)] focus:before:transition-[box-shadow_0.2s,transform_0.2s] checked:focus:border-primary checked:focus:before:scale-100 checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca] checked:focus:before:transition-[box-shadow_0.2s,transform_0.2s] dark:border-neutral-600 dark:checked:border-primary dark:checked:after:border-primary dark:checked:after:bg-primary dark:focus:before:shadow-[0px_0px_0px_13px_rgba(255,255,255,0.4)] dark:checked:focus:border-primary dark:checked:focus:before:shadow-[0px_0px_0px_13px_#3b71ca]"
                                type="radio" name="sex" id="sexF" value="f" wire:model="profileForm.sex" />
                ...
                <div class="col-span-3">
                    ...
                    <x-simple-select class="bg-white" wire:model="profileForm.gender_id" name="gender_id" id="gender_id" :options="$profileForm->genders()" value-field='id' text-field='name'
                    ...
                    <x-input-error for="profileForm.gender_id" class="mt-1" />
                </div>
                <x-hr.narrow class="col-span-6 !my-0" />
                ...
                <div class="col-span-6 md:col-span-3">
                    ...
                    <div wire:ignore>
                        <div class="relative mb-3" data-te-format="yyyy-mm-dd" data-te-show-format="true" data-te-disable-future="true" data-te-datepicker-init data-te-input-wrapper-init
                            data-te-inline="true">
                            <x-input id="dob" type="text" wire:model="profileForm.dob" wire:dirty.class="bg-warning-100"
                ...
                <div class="col-span-6">
                    ...
                    <x-input-error for="profileForm.pob" class="mt-1" />
                </div>
                <x-hr.narrow class="col-span-6 !my-0" />

                <!-- image -->
                <div class="col-span-6">
                    <x-label for="image" value="{{ __('person.reupload_photo') }}" />
                    ...
                    <x-input-error for="profileForm.image" />
                    ...
                    <div class="col-span-6">
                        ...
                        @if ($profileForm->image)
                            <img class="block mt-2 rounded w-36" src="{{ $profileForm->image->temporaryUrl() }}" alt="image preview" />
                        @endif
                    </div>
                </div>
            </div>
        ...
        <div class="flex items-center justify-end px-4 py-3 text-right sm:px-6 rounded-b">
            ...
            <div class="flex-grow max-w-full flex-1 text-end">
                <x-button.secondary class="mr-2" wire:click="resetProfile()" wire:dirty>
                    {{ __('app.cancel') }}
                </x-button.secondary>
