        ...
        <x-ts-tab.items tab="{{ __('person.add_new_person_as_mother') }}">
            <div class="p-4 rounded-sm md:w-192 bg-neutral-200">
                ...
                <div class="grid grid-cols-6 gap-5">
                    ...
                    {{-- yob --}}
                    <div class="col-span-6 md:col-span-3">
                        <x-ts-input wire:model="motherForm.yob" id="yob" label="{{ __('person.yob') }} :" wire:dirty.class="bg-yellow-200 dark:text-black" autocomplete="yob" type="number" max="{{ date('Y') }}" />
                    </div>
