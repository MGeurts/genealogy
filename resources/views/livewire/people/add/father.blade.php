        ...
        <x-ts-tab.items tab="{{ __('person.add_new_person_as_father') }}">
            <div class="md:w-192 p-4 rounded bg-neutral-200">
                ...
                <div class="grid grid-cols-6 gap-5">
                    ...
                    {{-- birthname --}}
                    <div class="col-span-6 md:col-span-3">
                        <x-ts-input wire:model="fatherForm.birthname" id="birthname" label="{{ __('person.birthname') }}" wire:dirty.class="bg-warning-200 dark:text-black" autocomplete="birthname" />
                    </div>
