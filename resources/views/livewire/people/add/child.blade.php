        ...
        <x-ts-tab.items tab="{{ __('person.add_new_person_as_child') }}">
            <div class="p-4 rounded md:w-192 bg-neutral-200">
                ...
                <div class="grid grid-cols-6 gap-5">
                    ...
                    {{-- marriedname --}}
                    <div class="col-span-6 md:col-span-3">
                        <x-ts-input wire:model="childForm.marriedname" id="marriedname" label="{{ __('person.marriedname') }} :" wire:dirty.class="bg-warning-200 dark:text-black" autocomplete="marriedname" />
                    </div>
