<div class="max-w-5xl grow dark:text-neutral-200">
    <div
        class="print:break-before-page flex flex-col rounded bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 text-neutral-800 dark:text-neutral-50">
        {{-- card header --}}
