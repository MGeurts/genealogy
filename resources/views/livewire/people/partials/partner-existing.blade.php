<div>
    <div class="p-4 md:w-3xl bg-neutral-200">
        ...
        <div class="col-span-6">
            {{-- person_id --}}
            <x-ts-select.styled wire:model="form.person_id" id="person_id" label="{{ __('person.person') }} : *" :options="$persons" select="label:name|value:id" placeholder="{{ __('app.select') }} ..." searchable lazy="10" >
                <x-slot:after>
